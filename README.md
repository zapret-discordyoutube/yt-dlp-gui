...
- Единственное, что сохраняется на диск, — обезличенные суточные счётчики
  в `data/stats.sqlite3`: количество запросов, загрузок и сумма отданных байт.
  Ни ссылок, ни адресов, ни User-Agent — восстановить по ним чьи-либо действия нельзя.
