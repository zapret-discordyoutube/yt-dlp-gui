...
# Умеренно: много одновременных соединений к googlevideo чаще ловят
# TLS-таймауты и роняют загрузку. 4 — баланс скорости и стабильности.
CONCURRENT_FRAGMENTS = int(os.environ.get("YTG_CONCURRENT_FRAGMENTS", "4"))
